...
{{--    --}}
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            ...
            <span class="brand-text font-weight-light">Huhu Eval</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Tafitasoa Tanjonirina</a>
                </div>
            </div>
            <!-- Sidebar Menu -->
            <nav class="mt-2">
...
<!-- Main Footer -->
    <footer class="main-footer">
        <!-- To the right -->
        <!-- Default to the left -->
        <strong>Copyright &copy; 2024 Tafitasoa Tanjonirina </strong>
    </footer>
</div>
<!-- ./wrapper -->
